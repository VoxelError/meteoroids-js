...
document.addEventListener("keydown", (event) => {
	...
	event.code == "ArrowRight" && (ship.rot = -to_radians(1.5))
	event.code == "ArrowLeft" && (ship.rot = to_radians(1.5))
...
export default (context) => {
	...
	const thrust_ship = () => {
		...
		ship.thrust.x += (cos(a) * 0.03)
		ship.thrust.y -= (sin(a) * 0.03)
		fxThrust.play()
